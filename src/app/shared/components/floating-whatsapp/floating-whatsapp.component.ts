...
@Component({
  ...
  template: `
    <a
      ...
      aria-label="Chat on WhatsApp with Heshiv Mobility">
...
export class FloatingWhatsappComponent {
  get whatsappUrl(): string {
    const text = encodeURIComponent(`Hello ${BUSINESS_INFO.companyName}, I would like to enquire about a travel package.`);
